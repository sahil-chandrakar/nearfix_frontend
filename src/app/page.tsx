...
const cards: HomeCard[] = [
  {
    title: "For Customers",
    description:
      "Find and book trusted local service professionals in your area instantly.",
  ...
  },
  {
    ...
    description:
      "Join our network, connect with customers, and grow your business.",
    buttonLabel: "Provider Portal",
    href: "/provider/login",
    icon: "provider",
  },
];
